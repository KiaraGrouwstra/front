...
req.src = "://cdn.jsdelivr.net/requirejs/2.1.20/require.min.js";
document.getElementsByTagName('head')[0].appendChild(req);

/*
requirejs.config({
    paths: {
        'request': '//raw.githubusercontent.com/request/request/master/request'
    }
});
...
var req = document.createElement('script');
req.src = "://rawgit.com/request/request/master/request.js";
document.getElementsByTagName('head')[0].appendChild(req);
*/
