...
Promise.prototype.do = function(fn1, fn2 = (e) => console.log(e)) {
  return this.then(do_return(fn1), do_return(fn2));
}
let Prom_either = Promise.prototype.either = function(fn) {
  return this.do(fn, fn);
}
Promise.prototype.toast_result = function(msg) {
...
export { handle_auth, popup, toast, setKV, getKV, Prom_either, spawn_n, arr2obj, mapBoth };  //, Obs_do, Obs_then
